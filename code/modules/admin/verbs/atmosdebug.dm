/client/proc/atmosscan()
	...
	#ifndef DEBUG_MAPS
	to_chat(src, span_bolddanger("DEBUG_MAPS is not defined, this does not work!"))
	#endif
	...
	for(var/obj/machinery/atmospherics/components/pipe in ::atmospherics)
	...
	//Pipes
	for(var/obj/machinery/atmospherics/pipe/pipe in ::atmospherics)
	...
	//Nodes
	for(var/obj/machinery/atmospherics/node1 in ::atmospherics)
