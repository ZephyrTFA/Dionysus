@REM Script to easily upload dionysus.rsc to your FTP-server so that clients download it from an
...
@REM Replace FOLDER/FOLDER with the folder on the FTP server where you want to store dionysus.rsc, for example: cd www/rsc
@REM Replace FTP.DOMAIN.COM with the IP-address or domain name of your FTP server
@REM Add the URL to the location of dionysus.rsc on your webserver into data\external_rsc_urls.txt
@REM
@echo off
...
echo put ..\..\dionysus.rsc>> ftpcmd.dat
